...
const CreatePost: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        {error && (
          <Typography sx={{ color: "#d32f2f", fontSize: "0.85rem", px: 1 }}>
            {error}
          </Typography>
        )}
        ...
        <Paper
          elevation={0}
          sx={{ p: 2, borderRadius: 3, border: "1px solid #EBEBF0" }}
        >
          <Box sx={{ mb: 2 }}>
            <Typography
              variant="caption"
          ...
          <Box>
            ...
            <Box sx={{ display: "flex", alignItems: "center", mt: 0.5 }}>
              <LocationOnOutlined
                sx={{ color: "#9E9EB0", fontSize: 18, mr: 0.5 }}
              />
              <TextField
                fullWidth
                variant="standard"
        ...
        <Paper
          elevation={0}
          onClick={() =>
            !imagePreview && !existingImageUrl && fileInputRef.current?.click()
          }
          sx={{
            borderRadius: 3,
            border: "1px dashed #C7B9FF",
            cursor: imagePreview || existingImageUrl ? "default" : "pointer",
            overflow: "hidden",
          }}
        >
          <input
          ...
          {imagePreview || existingImageUrl ? (
            ...
            >
              <AddPhotoAlternateOutlined
                sx={{ fontSize: 36, color: "#C7B9FF" }}
              />
              <Typography sx={{ color: "#9E9EB0", fontSize: "0.85rem" }}>
                Tap to add a photo
              </Typography>
            </Box>
          )}
        ...
        >
          ...
          {rating ? (
            <Typography sx={{ fontSize: "0.8rem", color: "#9E9EB0", mt: 0.5 }}>
