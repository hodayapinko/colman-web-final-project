    ...
    >
        ...
        <Box sx={{ position: "relative" }}>
          ...
          {post.rating != null && (
            ...
            >
              ...
              <Typography
                sx={{ fontSize: "0.8rem", fontWeight: 700, color: "#1A1A2E" }}
              >
                {post.rating}
              </Typography>
            </Box>
      ...
      <Box sx={{ p: 2 }}>
        ...
        <Box
          sx={{
            display: "flex",
            alignItems: isMine ? "flex-start" : undefined,
            justifyContent: isMine ? "space-between" : undefined,
            mb: 0.25,
          }}
        >
          <Typography
            sx={{
              fontWeight: 800,
              fontSize: isFeed || isMine ? "1.05rem" : "1.1rem",
              color: "#1A1A2E",
            }}
          >
            {post.title}
        ...
        {post.location && (
          <Typography sx={{ fontSize: "0.8rem", color: "#9E9EB0", mb: 0.75 }}>
            {post.location}
          </Typography>
        )}
        {post.content && (
          <Typography
            sx={{
              fontSize: isFeed || isMine ? "0.88rem" : "0.9rem",
              color: "#444",
              lineHeight: isFeed || isMine ? 1.6 : 1.7,
        ...
        {isFeed && (
          <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
            ...
            >
              ...
              <Typography
                sx={{ fontSize: "0.82rem", fontWeight: 600, color: "#6344F5" }}
              >
                {commentCount ?? 0}
              </Typography>
            </Box>
